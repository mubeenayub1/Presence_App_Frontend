...
const Login = () => {
  ...
  const handleBtn = () => {
    ...
    myHeaders.append(
      'Cookie',
      'token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NDE3NDA2ZjZmYmQ3YjRjYWJmNDczODUiLCJpYXQiOjE2Nzk1MjAzMjEsImV4cCI6MTY4MDgxNjMyMX0.siXpbkH1Y326-_zc6P3xKgRL1bsUUn290Dr1CsTKTUo',
    );
      ...
      <View style={{alignSelf: 'center', width: widthPercentageToDP(90)}}>
        ...
        <Shadow
          ...
          <LinearGradient
            ...
            <Image
              style={{width: 13.93, height: 18.89, marginHorizontal: 20}}
